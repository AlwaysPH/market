...
public class ExcelUtil<T> {
    ...
    public String encodingFilename(String filename) {
        filename = filename + "_" + DateUtils.getDate() + ".xlsx";
        return filename;
    }
     ...
     * @param response
     */
    public static void downloadTemp(HttpServletResponse response,String tempName) {
        InputStream is = null;
        try {
            Resource[] resource = new PathMatchingResourcePatternResolver().getResources("classpath*:excel/*.*");
            for (Resource resource1 : resource) {
                if(tempName.equals(resource1.getFilename())){
